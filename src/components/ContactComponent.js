...
import { Breadcrumb, BreadcrumbItem, FormGroup, Label, Col, Input, Form, Button, Row} from 'reactstrap';
                    ...
                    <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={{size: 3, offset: 1}}>
                                <Control.select model=".contectType" name="contactType" className="form-check-input">
                                    <option>Tel.</option>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".message" id="massage" name="message" rows="12"
